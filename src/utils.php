...
require_once './php/product/product.model.php';
require_once './php/product/product.service.php';
require_once './php/category/category.model.php';
require_once './php/category/category.service.php';
...
function fetchAndFillProducts($page, $category){
    ...
    foreach($products as $product){
        $productsList .= '<li class="category-product">' . '<a href="./product-details-page/product-details-page.php?id=' . $product->getId() . '"><img src="' . $product->getMainImage() . '" />' . '<p>' . $product->getName() . '</p></a></li>';
    }
