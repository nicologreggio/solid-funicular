...
(9, 'Percorso Vita', 'Il nostro Percorso Vita si compone di varie stazioni, con diversi livelli di difficolta\'. <br>\r\nE\' diviso in tre categorie a seconda degli utenti: adulti, ragazzi, e per chi ha difficolta\' motorie. <br>\r\nDispone anche di App dedicata, che consente di utilizzare al meglio l\'attrezzo, e di avere in tempo reale tutti i dati riguardanti il consumo calorico, le istruzioni di utilizzo, e i vari livelli di difficolta\' da poter eseguire.', 'Il nostro Percorso Vita si compone di varie stazioni, con diversi livelli di difficoltà. E\' diviso in tre categorie a seconda degli utenti: adulti, ragazzi, e per chi ha difficoltà motorie. Dispone anche di App dedicata, che consente di utilizzare al meglio l\'attrezzo, e di avere in tempo reale tutti i dati riguardanti il consumo calorico, le istruzioni di utilizzo, e i vari livelli di difficoltà da poter eseguire.', b'0');
